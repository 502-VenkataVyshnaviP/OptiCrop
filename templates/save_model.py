...
# 1. Generate clean mock data matching your OptiCrop parameter specs
np.random.seed(42)
num_samples = 200
...
# Define simple agricultural crop labeling rules matching your system context
crops = ['rice', 'maize', 'chilli', 'cotton', 'coffee']
df['crop'] = np.random.choice(crops, num_samples)

# 2. Extract inputs and train the Model matching your Logistic Regression setup
...
# 3. Save it securely as model.pkl right into your main workspace directory
